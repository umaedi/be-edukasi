...
Route::prefix('public')->group(function () {
    ...
    //index educations
    Route::get('/educations', [App\Http\Controllers\Api\Public\EducationController::class, 'index']);

    //show education
    Route::get('/educations/{slug}', [App\Http\Controllers\Api\Public\EducationController::class, 'show']);

    //index posts home
    Route::get('/posts_home', [App\Http\Controllers\Api\Public\PostController::class, 'homePage']);

    //index educations home
    Route::get('/educations_home', [App\Http\Controllers\Api\Public\EducationController::class, 'homePage']);
